...
export default function PlaceGallery({place}) {
        ...
        return(
            ...
            <div>
              <h2 className="text-2xl mr-36">Photos of {place.title}</h2>
                <button onClick={()=>setShowAllPhotos(false)} className="flex right-12 top-8 fixed gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M6 18 18 6M6 6l12 12" />
    ...
    <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
     ...
     <button onClick={()=>setShowAllPhotos(true)} className="absolute flex gap-2 bottom-2 right-2 py-2 px-4 bg-white rounded-2xl shadow-md shadow-gray-500">
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
